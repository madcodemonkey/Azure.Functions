...
[assembly: FunctionsStartup(typeof(InProcessHubExample.Startup))]
...
public class Startup : FunctionsStartup
{
    ...
    public override void Configure(IFunctionsHostBuilder builder)
    {
        ...
        {
            EventHubConnectionString = configuration["EventHubConnectionString"], // configuration will be populated with both environment variables (default behavior) and app configuration (due to code below).
            EventHubName = configuration["EventHubName"]
        };

        builder.Services.AddHubExampleServices(setting);
    }
