...
1. One hooks up to an existing service bus.  Currently it will receive the Deal.cs class (under HubExample.Model library) from the service bus queue specified in the local.settings.json file.
